...
function downloadQuestions() {
  let questions = JSON.parse(JSON.stringify(questionRepo.with('answers').get()))
  ...
  downloadString(JSON.stringify(questions, null, 2), 'text/json', 'questions.json')
}
...
<template>
  <div class="edit">
    ...
    <p class="note">
      NOTE: Remember to save each question you modify or your changes will be lost.
    </p>
