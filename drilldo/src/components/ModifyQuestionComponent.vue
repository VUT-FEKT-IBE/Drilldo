...
function validateQuestionNumber() {
  ...
  const existingQuestion = questionRepo.where('number', Number(editQuestion.value.number)).first()
  ...
  <div class="question">
    <div class="question-data">
      <div class="question-title">
        <input v-model="editQuestion.number" type="number" name="number" />
        <input
    ...
    <div v-if="editQuestion.image !== ''" class="image">
      <img :src="editQuestion.image" />
    </div>
    <div class="answers">
